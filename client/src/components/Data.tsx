      ...
      >
        <Tab eventKey="betas" title="Betas">
          <p className="text-muted small mt-2">
            ...
            . A million thanks for making valuable data publicly available. <FaIcon icon={faHeart} />
          </p>
          <p className="text-muted small">2) All betas are unlevered betas corrected for cash.</p>
